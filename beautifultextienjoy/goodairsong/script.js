function english() {
  ...
  disclaimer =
    "to understand this, you must have a knowledge of english, asian culture, singlish, manglish, classical musicians, hex code, chinese music, onomatopoeia, hokkien, mathematics, the way that asian grandparents talks, fengshui and european countries. enjoy";
  htmlText = text.replace(/(?:\r\n|\r|\n)/g, "<br>");
  finalArray = [title, author, introText, htmlText, disclaimer];
  return finalArray;
}
